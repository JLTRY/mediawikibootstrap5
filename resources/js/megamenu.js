/* taken form template ja_puruty_iv */
jQuery(document).ready(function ($) {
  ...
  var navitem_selector = ".navbar-nav .nav-item";
  ...
  $(".nav-item.dropdown > .dropdown-toggle").on('touchstart', function (e) {
    ...
    if (window.outerWidth > 990) {
      ...
      $('.navbar-nav .nav-item.dropdown').each((i, el) => {
  ...
  $(document).on('click', e => {
    ...
    $('.navbar-nav .nav-item.dropdown.show').each((i, el) => {
      hideDropdowns($(el));
    })
  })
